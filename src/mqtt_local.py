...
# change as needed for your device and network
config['server'] = '192.168.1.3'
config['ssid'] = 'CJCNET'
config['wifi_pw'] = 'LostAgain2'
DEVICE_NAME = 'test_micropython'
config['HAVE_RANGER'] = False

# should not have to change anything below
config['DEVICE_NAME'] = DEVICE_NAME
config['Msg_Topic'] = f'homie/{DEVICE_NAME}/display/text/set'
config['Cmd_Topic'] = f'homie/{DEVICE_NAME}/display/cmd/set'
config['Rgr_Topic'] = f'home/{DEVICE_NAME}/ranger/distance'
config['Cmd_Ranger'] = f'homie/{DEVICE_NAME}/ranger/cmd/set'
